...
- [x] 1.5 Implement preprocessing pipeline: DICOM → HU normalization → **16-bit HU slice PNG** output + index/manifest (windowing deferred to training for random windowing).
